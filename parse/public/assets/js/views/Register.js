...
App.Views.Register = Backbone.View.extend({
    ...
    render: function() {
        ...
        Parse.Cloud.run("registrationForm", {}, {
            success: function(result) {
                ...
                var registerEl = $(".register"), cameraEl = $("#camera");
    ...
    capture: function(e) {
        ...
        if (!window.navigator.camera) {
            ...
            self.$el.find(".step-4").show();
            var selfie = document.getElementById("selfie");
            var video = document.getElementById("camera"), selfieContext = selfie.getContext("2d");
    ...
    submit: function(e) {
        var self = this, newEmail = $("input#email").val().toLowerCase(), newName = $("input#name").val(), newTitle = $("input#title").val().toLowerCase(), newPassword = $("input#password").val(), newDepartment = $("select#department").val(), newOffice = $("select#office").val();
    ...
    savePicture: function(e) {
        ...
        file.save().then(function(file) {
            var Photos = Parse.Object.extend("Photos"), photo = new Photos();
    ...
    suggestName: function(e) {
        var self = this, input = e.currentTarget.value.toLowerCase();
