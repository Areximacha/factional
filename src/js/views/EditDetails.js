...
App.Views.EditDetails = Backbone.View.extend({
    ...
    toggleEdit: function(e) {
        ...
        var self = this,
            detailsForm = self.$el.find('#editDetails'),
            inputTitle = detailsForm.find('#title'),
            inputDepartment = detailsForm.find('#department'),
            inputOffice = detailsForm.find('#office'),
            inputSubmit = detailsForm.find('#submit');
    ...
    submit: function(e) {
        ...
        var newName = $(e.currentTarget).find('#name').val(),
            newTitle = $(e.currentTarget).find('#title').val(),
            newDepartment = $(e.currentTarget).find('#department').val();
